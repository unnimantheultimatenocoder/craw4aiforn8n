...
Path Parameters  
---  
`folder_name` Folder Name — **REQUIRED**  
...
`msg` Message  
`type` Error Type  
[PreviousDownload Image](https://docs.langflow.org/api/</api/download-image>)[NextList Profile Pictures](https://docs.langflow.org/api/</api/list-profile-pictures>)
