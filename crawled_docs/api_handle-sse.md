...
[![Langflow](https://docs.langflow.org/img/langflow-logo-black.svg)![Langflow](https://docs.langflow.org/img/langflow-logo-white.svg)](https://docs.langflow.org/api/</>)
  ...
  * [mcp](https://docs.langflow.org/api/</api/handle-sse>)
    * [Handle Sse](https://docs.langflow.org/api/</api/handle-sse>)
    * [Handle Messages](https://docs.langflow.org/api/</api/handle-messages>)
...
[PreviousGet Starter Projects](https://docs.langflow.org/api/</api/get-starter-projects>)[NextHandle Messages](https://docs.langflow.org/api/</api/handle-messages>)
