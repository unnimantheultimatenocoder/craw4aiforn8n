...
`msg` Message  
`type` Error Type  
[PreviousDownload File](https://docs.langflow.org/api/</api/download-file>)[NextDownload Profile Picture](https://docs.langflow.org/api/</api/download-profile-picture>)
