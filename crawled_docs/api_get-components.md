...
`msg` Message  
`type` Error Type  
[PreviousShare Component](https://docs.langflow.org/api/</api/share-component>)[NextUpdate Shared Component](https://docs.langflow.org/api/</api/update-shared-component>)
