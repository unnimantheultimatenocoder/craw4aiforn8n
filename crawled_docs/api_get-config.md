...
---  
`feature_flags` object| `mvp_components` Mvp Components — **OPTIONAL**  
---  
`frontend_timeout` Frontend Timeout  
`auto_saving` Auto Saving  
`auto_saving_interval` Auto Saving Interval  
`health_check_max_retries` Health Check Max Retries  
`max_file_size_upload` Max File Size Upload  
[PreviousCustom Component Update](https://docs.langflow.org/api/</api/custom-component-update>)[NextPost Validate Code](https://docs.langflow.org/api/</api/post-validate-code>)
